...
const SmartInvestmentsSection = () => {
  const investments = [
    {
      iconLink:
        "/Real_Estate_X4//assets/icons/servicepage/smart/network.svg",
      investmentTitle: "Market Insight",
      investmentBrief:
        "Stay ahead of market trends with our expert Market Analysis. We provide in-depth insights into real estate market conditions  ",
    },
    {
      iconLink: "/Real_Estate_X4//assets/icons/servicepage/smart/fire.svg",
      investmentTitle: "ROI Assessment",
      investmentBrief:
        "Make investment decisions with confidence. Our ROI Assessment services evaluate the potential returns on your investments",
    },
    {
      iconLink: "/Real_Estate_X4//assets/icons/servicepage/smart/bulb.svg",
      investmentTitle: "Customized Strategies",
      investmentBrief:
        "Every investor is unique, and so are their goals. We develop Customized Investment Strategies tailored to your specific needs",
    },
    {
      iconLink: "/Real_Estate_X4//assets/icons/servicepage/smart/sun.svg",
